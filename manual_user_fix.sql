...
-- This will create your user record and fix the RPC function

-- 1. Create user record manually for peter@omalley.io
...
-- 2. Fix the RPC function with proper type casting
