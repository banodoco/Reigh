      ...
      {lightboxIndex !== null && currentLightboxImage && (
        <MediaLightbox
          ...
          onOpenExternalGeneration={async (generationId: string, derivedContext?: string[]) => {
            ...
            console.log('[TimelineRefactored:DerivedNav] 📥 Generation not in timeline, checking database');
            try {
              ...
              if (data) {
                console.log('[TimelineRefactored:DerivedNav] ✅ Generation exists in database but not in timeline');
              ...
              console.error('[TimelineRefactored:DerivedNav] ❌ Error checking generation:', error);
              toast.info('This generation is not in the current timeline view.');
            }
          }}
