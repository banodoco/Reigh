...
const Visualization: React.FC<{
    ...
    // For visualization, assume clips are ~100 frames each
    const assumedClipLength = 100;
    
    // In REPLACE mode: Gap includes context frames (replaces the seam)
    // In INSERT mode: Context frames are separate from gap
    const clipAKeptFlex = replaceMode 
        ? (assumedClipLength - contextFrames) * 0.3  // Kept portion (before replacement)
        : assumedClipLength * 0.3;  // Full clip
    
    const clipBKeptFlex = replaceMode 
        ? (assumedClipLength - contextFrames) * 0.3  // Kept portion (after replacement)
        : assumedClipLength * 0.3;  // Full clip
    ...
    return (
        <div className="border rounded-lg p-4 bg-background/50 text-xs h-full flex flex-col">
            ...
            <div className="flex h-16 w-full mb-4 rounded-md overflow-hidden border bg-background shadow-sm relative">
                {/* Clip A - Kept portion */}
                <TooltipProvider>
                    <Tooltip>
                    ...
                    >
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p className="max-w-xs text-xs">
                                        New frames generated by VACE to replace the seam between clips, creating a smooth transition.
                                    </p>
                                </TooltipContent>
                            </Tooltip>
                        </TooltipProvider>
                        ...
                        {keepBridgingImagesValue && (
                            <>
                                ...
                                <div className="absolute bottom-0.5 left-1/2 -translate-x-1/2 text-[7px] text-blue-600 dark:text-blue-400 font-bold z-10 bg-background/80 px-1 rounded">
                                    2 anchors
                                </div>
                            </>
                        )}
                    ...
                    <>
                        ...
                        <TooltipProvider>
                            ...
                            {keepBridgingImagesValue && (
                                ...
                                <TooltipContent>
                                    <p className="max-w-xs text-xs">
                                        New frames generated by VACE and inserted between the two clips to create a smooth transition.
                                    </p>
                                </TooltipContent>
                            </Tooltip>
                        </TooltipProvider>
            ...
            <div className="relative w-full h-6 mb-2">
                ...
                >
                    ...
                    {/* Left bracket */}
                    <div className="absolute left-0 top-0 w-px h-2 bg-foreground/30"></div>
                    {/* Right bracket */}
                    <div className="absolute right-0 top-0 w-px h-2 bg-foreground/30"></div>
                    {/* Label */}
                    <div className="mt-0.5 text-[9px] font-mono text-foreground/60 whitespace-nowrap">
                        Generation Window: {totalFrames}f
                    </div>
                </div>
            </div>
            </div>
                    ...
                    <div className="grid grid-cols-2 gap-x-6 gap-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <Slider
                                ...
                                className="py-2"
                            />
                            <p className="text-xs text-muted-foreground">Frames generated in transition</p>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            />
                            <p className="text-xs text-muted-foreground">Frames kept from each clip</p>
                        </div>
                             ...
                             <div className="flex items-center gap-2">
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent>
                                            <p className="max-w-xs text-xs">Keeps guide frames inside the transition to help guide the generation.</p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                             </div>
