...
interface GalleryVideoScrubberProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onTouchEnd'> {
  /**
 ...
 * Local copy of HoverScrubVideo specific to ImageGallery.
 */
const GalleryVideoScrubber: React.FC<GalleryVideoScrubberProps> = ({
  src,
  poster,
  className,
  videoClassName,
...
export default GalleryVideoScrubber;
