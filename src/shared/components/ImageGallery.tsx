...
export const ImageGallery: React.FC<ImageGalleryProps> = ({ 
  ...
  // Handle showing all shots (reset filter)
  ...
  const { currentShotDisplayText, switchButtonText, showAllButtonText, showBothButtons } = React.useMemo(() => {
