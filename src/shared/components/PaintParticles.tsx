...
export const PaintParticles: React.FC = () => {
  return (
    <div className="absolute left-4 z-0" style={{ bottom: '1px' }}>
      ...
      <div className="absolute bg-white/80 rounded-full opacity-0 group-hover:animate-paint-particle-fractal-1" style={{ bottom: '0px', left: '4px', width: '1.5px', height: '1.5px' }}></div>
      
      {/* Third particle continuing straight trajectory */}
      <div className="absolute bg-white/60 rounded-full opacity-0 group-hover:animate-paint-particle-fractal-2" style={{ bottom: '2px', left: '6px', width: '1px', height: '1px' }}></div>
    </div>
  );
}; 