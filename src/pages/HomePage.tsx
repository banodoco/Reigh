    ...
    <PageFadeIn className="min-h-screen wes-texture relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 min-h-screen flex items-center justify-center">
        ...
        */}
        ...
        <div className={`fixed top-0 right-0 h-full w-5/6 max-w-sm sm:w-96 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className={`fixed top-0 left-0 h-full w-5/6 max-w-sm sm:w-96 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
