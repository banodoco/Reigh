-- Fix the root cause: Update generation trigger to properly extract shot_id from originalParams.orchestrator_details.shot_id
-- This addresses the core issue where video generations weren't being associated with shots
...
'Fixed to properly extract shot_id from originalParams.orchestrator_details.shot_id path, which is the most common location for wan_2_2_i2v tasks';
