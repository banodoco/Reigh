-- Update trigger to extract thumbnail_url from task params (complete_task auto-generated thumbnails)
-- This ensures thumbnails generated by complete_task are properly saved to generations.thumbnail_url
...
BEGIN
    ...
    IF NEW.status = 'Complete'::task_status
       ...
       AND task_category = 'generation' THEN
        ...
        -- ENHANCED: Extract thumbnail_url from params (prioritize complete_task auto-generated thumbnails)
        BEGIN
...
-- Log confirmation
SELECT 'Updated trigger to extract thumbnail_url from task params and save to generations.thumbnail_url' as status;
