-- Fix JSONB to UUID casting errors in create_generation_on_task_complete function
-- This restores the safe exception handling that was accidentally removed in the February 3rd migration
...
SELECT 'Fixed JSONB to UUID casting errors in create_generation_on_task_complete function' as status;
