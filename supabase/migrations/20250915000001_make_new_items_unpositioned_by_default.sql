-- Make new items unpositioned by default
-- Change the default add_in_position from true to false in the generation trigger
...
-- Log confirmation
SELECT 'Changed default positioning to false - new items will be unpositioned by default' as status;
