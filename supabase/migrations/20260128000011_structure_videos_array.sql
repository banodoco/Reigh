-- Update RPC to include full structureVideos array with start_frame/end_frame
-- This allows share pages to properly crop/position structure videos on the timeline
