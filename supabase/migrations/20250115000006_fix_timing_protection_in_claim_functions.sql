-- Fix timing field protection in claim functions
-- This restores the application_name setting that was removed in the worker_id migration

-- Updated func_claim_task with timing protection
...
BEGIN
    -- CRITICAL: Set application name to allow timing field updates
    ...
    -- ONLY for users with positive credits
    ...
    -- If found, update with worker_id and start time
...
-- Updated func_claim_user_task with timing protection
