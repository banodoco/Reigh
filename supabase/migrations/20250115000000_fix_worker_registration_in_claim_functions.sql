-- Fix worker registration in claim functions
-- This ensures workers are automatically registered before being assigned to tasks

-- Updated func_claim_task with auto worker registration
...
-- Updated func_claim_user_task with auto worker registration
