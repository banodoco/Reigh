-- Add parent_generation_id to RPC output for proper video filtering
-- This allows useSegmentOutputsForShot to identify parent vs child videos
...
BEGIN
  ...
  -- 5. Get shared generation (the specific video being shared)
  ...
  -- 6. Return data - settings is RAW from database, no transformation
