-- Update task claim functions to set worker_id
-- This fixes the atomic claim by including worker assignment

-- Updated func_claim_user_task
    ...
    RETURN QUERY EXECUTE format('
        ...
        updated_task AS (
            ...
            SET status = ''In Progress'', 
                ...
                worker_id = $1  -- ADDED: Assign worker
...
BEGIN
    ...
    IF v_claimed_task_id IS NOT NULL THEN
        ...
        SET
            status = 'In Progress',
            generation_started_at = NOW(),
            worker_id = p_worker_id  -- ADDED: Assign worker
