-- Fix PAT claim function - fix RETURN TABLE syntax and CTE structure
-- The issue is with how we're handling the SELECT/RETURN in the function
...
COMMENT ON FUNCTION claim_next_task_user_pat IS 'PAT-friendly version: Atomically claims next eligible task for specific user without credits or run_type constraints. Fixed RETURN QUERY syntax.';
