-- Fix ambiguous column reference error in add_generation_to_shot
-- The previous migration had "WHERE id = existing_record.id" which is ambiguous
-- This fixes it to "WHERE shot_generations.id = existing_record.id"
