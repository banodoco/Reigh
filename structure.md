...
| **Realtime Architecture** | [realtime_simplification_plan.md](structure_detail/realtime_simplification_plan.md) | Centralized realtime system with unified invalidation routing |
