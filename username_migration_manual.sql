-- Manual username system implementation
-- Run this in Supabase SQL Editor

-- Step 1: Add username column to users table
ALTER TABLE users ADD COLUMN IF NOT EXISTS username text UNIQUE;

-- Step 2: Create function to sanitize Discord handles into domain-safe usernames
...
-- Step 4: Create function to extract Discord username from auth metadata
...
-- Step 5: Update the user creation function to include username generation
...
-- Verification query - check that usernames were generated
SELECT 
  id, 
  name, 
  email, 
